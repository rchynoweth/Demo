...
-- MAGIC To run this demo, just select the cluster `dbdemos-dlt-loans-ryan_chynoweth` from the dropdown menu ([open cluster configuration](https://adb-984752964297111.11.azuredatabricks.net/#setting/clusters/0315-221411-pcp7qyb1/configuration)). <br />
...
-- MAGIC <img width="1px" src="https://www.google-analytics.com/collect?v=1&gtm=GTM-NKQ8TT7&tid=UA-163989034-1&cid=984752964297111&aip=1&t=event&ec=dbdemos&ea=VIEW&dp=%2F_dbdemos%2Fdata-engineering%2Fdlt-loans%2F03-Log-Analysis&uid=6563461962580955">
...
-- MAGIC %md
-- MAGIC Your expectations are ready to be queried in SQL! Open the <a href="https://e2-demo-field-eng.cloud.databricks.com/sql/dashboards/c3172647-0b0e-4c5e-9967-5a930ab8d81e-dlt---retail-data-quality-stats?o=1444828305810485" target="_blank">data Quality Dashboard example</a> for more details.
