...
-- MAGIC 
-- MAGIC **Your DLT Pipeline is ready!** Your pipeline was started using this notebook and is <a dbdemos-pipeline-id="dlt-loans" href="/#joblist/pipelines/173f4e78-eb29-48ba-8493-e2aad6f33db1">available here</a>.
-- MAGIC 
-- MAGIC <!-- Collect usage data (view). Remove it to disable collection. View README for more details.  -->
-- MAGIC <img width="1px" src="https://www.google-analytics.com/collect?v=1&gtm=GTM-NKQ8TT7&tid=UA-163989034-1&cid=984752964297111&aip=1&t=event&ec=dbdemos&ea=VIEW&dp=%2F_dbdemos%2Fdata-engineering%2Fdlt-loans%2F01-DLT-Loan-pipeline-SQL&uid=6563461962580955">
...
-- MAGIC %md ## Next steps
-- MAGIC 
-- MAGIC Your DLT pipeline is ready to be started. <a dbdemos-pipeline-id="dlt-loans" href="/#joblist/pipelines/173f4e78-eb29-48ba-8493-e2aad6f33db1">Click here to access the pipeline</a> created for you using this notebook.
-- MAGIC 
