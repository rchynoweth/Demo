...
# MAGIC <img width="1px" src="https://www.google-analytics.com/collect?v=1&gtm=GTM-NKQ8TT7&tid=UA-163989034-1&aip=1&t=event&ec=dbdemos&ea=VIEW&dp=%2F_dbdemos%2Fdata-science%2Fmlops-end2end%2F01_feature_engineering&cid=984752964297111&uid=6563461962580955">
...
# MAGIC
# MAGIC Example AutoML Code:
# MAGIC ```
# MAGIC   from databricks import automl
# MAGIC   automl_run = databricks.automl.classify(
# MAGIC     dataset = dataset,
# MAGIC     target_col = target_col,
# MAGIC     timeout_minutes = timeout_minutes
# MAGIC   )
# MAGIC ```
