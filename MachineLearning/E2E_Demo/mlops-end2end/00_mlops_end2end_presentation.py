...
# MAGIC To run this demo, just select the cluster `dbdemos-mlops-end2end-ryan_chynoweth` from the dropdown menu ([open cluster configuration](https://adb-984752964297111.11.azuredatabricks.net/#setting/clusters/0707-124625-kzsv4ikt/configuration)). <br />
...
# MAGIC <img width="1px" src="https://www.google-analytics.com/collect?v=1&gtm=GTM-NKQ8TT7&tid=UA-163989034-1&aip=1&t=event&ec=dbdemos&ea=VIEW&dp=%2F_dbdemos%2Fdata-science%2Fmlops-end2end%2F00_mlops_end2end_presentation&cid=984752964297111&uid=6563461962580955">
...
# MAGIC
# MAGIC Ultimately, we will be able to build a [complete DBSQL Churn Dashboard](/sql/dashboards/bcac9a27-1d9a-4ff6-a1a3-6d6e9e8ba138-churn-prediction-dashboard---universal?o=1444828305810485#) containing all our customer & churn information!
