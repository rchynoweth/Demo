...
# CREATE OR REPLACE TABLE advanced_churn_label_table (
...
#     num_optional_services DOUBLE,
#     transaction_ts TIMESTAMP not null
# );

# -- Add primary key constraint
# ALTER TABLE advanced_churn_label_table
#   ADD CONSTRAINT advanced_churn_label_table_pk PRIMARY KEY (customer_id, transaction_ts);
